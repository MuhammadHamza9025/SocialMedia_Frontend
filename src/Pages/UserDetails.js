...
const UserDetails = () => {
    ...
    const [userdetails, setdetails] = useReducer(reducer, initialState)
    const fetchuserdetailsdata = async () => {
        ...
        setdetails({ payload: Array(res), type: 'ready' })
    ...
    return (
        ...
        <>
            {
                userdetails.type == 'notready' ? <Loader /> :
                    <div className='flex flex-col items-center'>
                        ...
                        <Userposts userdetails={userdetails.users} heading='Your Posts' ></Userposts>
